...
public class ArrCharOps {
    ...
    public static char charAt(char[] arr, int index) {
        // I assumed the array is non-empty, as required.
    ...
    public static boolean equals(char[] arr1, char[] arr2) {
        // The rogram first checks if both arrays have the same length
    ...
    public static int lastIndexOf(char[] arr, char ch) {
        // The program iterates the array backwards
    ...
    */
    ...
    public static int compareTo(String str1, String str2) {
        // Program checks edge cases- errors
        if (str1 == "" && str2 == "") {
            return 0;
        }
        // Program checks if there's a nulll input or only one empty input
        if (str1 == null || str2 == null || str1.length() == 0 || str2.length() == 0) {
            return -2;
        }
        
        // Finding which one of the string is shorter, so the loop won't cause error.
        ...
        // Program finds which string is shorter (if they're equal - it returnes 0)
